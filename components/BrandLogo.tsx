...
export default function BrandLogo({
  ...
  // In Light Mode: White background, black border, black shadow, and crisp black logo path
  // In Dark Mode: Dark Zinc-900 background, white border, yellow shadow, and crisp white logo path
  // On Group Hover: Turns brutal-yellow with black logo
  return (
    <div
    ...
    >
      <svg
        viewBox="0 0 100 100"
        className="w-[82%] h-[82%] text-brutal-black dark:text-white group-hover:text-brutal-black dark:group-hover:text-brutal-black transition-colors duration-200"
        xmlns="http://www.w3.org/2000/svg"
      >
